                    ...
                    <div class="form-group  col-md-12 row" style="background-color: #F4F7FC; border-radius: 10px;">
                        <div class="form-group col-md-12 row" style="margin: 2%">
                            ...
                            <div class="form-group col-md-6">
                                <button type="button" class="btn btn-primary col-md-4 float-right" style="margin-right: 10%;">
                                <img style="width: 22px; margin-right:10%" src="../images/plus.png" >Add User</button>
                            </div>
                        </div>
