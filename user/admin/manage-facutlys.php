                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-sm-6 ">
                                                    <a href="" class="btn btn-info float-right" role="button" data-toggle="modal"
                                                        data-target="#addfaculty"><i class="mdi mdi-clipboard-plus"></i> Add Faculty
                                                    </a>
                                                </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="" class="btn btn-info" role="button"
                                                            data-toggle="modal" data-target="#editFaculty"><i
                                                                class="mdi mdi-pencil-outline"></i> </a>
                                                        <a href="" class="btn btn-danger" role="button"
                                                            data-toggle="modal" data-target="#deleteFaculty"><i
                                                                class="mdi mdi-delete"></i> </a>
                                                        <a href="" class="btn btn-primary" role="button"
                                                            data-toggle="modal" data-target="#detailFaculty"><i
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="inputFacultyId" name="facultyId"
                                                                    placeholder="Input Id" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="inputIdManager">ID Manager Faculty</label>
                                                                <input type="text" class="form-control"
                                                                placeholder="Input name" required>
                                                            </div>
                                                            <div class="form-group">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="inputfacultyId">Faculty ID</label>
                                                                <input type="text" class="form-control"
                                                                    id="inputFacultyId" name="facultyId" disabled
                                                                    value="Faculty_01">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="inputManager">Manager Faculty</label>
                                                                <input type="text" class="form-control"
                                                                    id="inputManager" placeholder="Nguyen Văn A">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="inputManager">Desciption</label>
                                                                <textarea class="form-control"
                                                            ...
                                                            <input type="button" class="btn btn-primary" name="change"
                                                                value="Save changes">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">
                                                                Close
