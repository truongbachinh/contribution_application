                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive p-t-10">
                                        <table id="example" class="table text-center" style="width:100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="" class="btn btn-info" role="button" data-toggle="modal" data-target="#editArticle"><i class="mdi mdi-pencil-outline"></i> </a>
                                                        <a href="" class="btn btn-danger" role="button" data-toggle="modal" data-target="#deleteArticle"><i class="mdi mdi-delete"></i> </a>
                                                        <a href="" class="btn btn-primary" role="button" data-toggle="modal" data-target="#detailArticle"><i class="mdi mdi-dots-horizontal"></i> </a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="inputNameArticle" name="nameArticle" placeholder="Advance Cloud" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="inputArticleId">Article ID</label>
                                                                <input type="text" class="form-control" id="inputArticleId" name="articleId" disabled value="Article_01">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" value="Nguyen Van A" disabled>
                                                            </div>
                                                            <div class="form-group">
                                        ...
                                        <div class="modal fade" id="detailArticle" tabindex="-1" role="dialog" aria-labelledby="detailArticle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
